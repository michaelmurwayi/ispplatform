...
class MpesaApiMpesacallbacks(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'mpesa_api_mpesacallbacks'


class MpesaApiMpesacalls(models.Model):
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
    ip_address = models.TextField()
    caller = models.TextField()
    ...
    class Meta:
        managed = False
        db_table = 'mpesa_api_mpesacalls'


class MpesaApiMpesapayment(models.Model):
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
    ...
    class Meta:
        managed = False
        db_table = 'mpesa_api_mpesapayment'
